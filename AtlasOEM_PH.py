...
class AtlasOEM_PH(AtlasOEM):
    ...
    def write_calibration_data1(self, val):
        self.write_32(0x08, (int)(val*1000))
        
    def write_calibration_data2(self, val):
        self.write_32(0x09, (int)(val*1000))
        
    def write_calibration_data3(self, val):
        self.write_32(0x0A, (int)(val*1000))
        
    def write_calibration_data4(self, val):
        self.write_32(0x0B, (int)(val*1000))
